...
GATE_STYLES_COLORFUL1 = {
    ...
    "Canonical": _orange_gate_style,
    "Can": _orange_gate_style,  # Alias for Canonical
...
class CircuitToQuantikz:
    ...
    def _get_gate_name(self, gate: ops.Gate) -> str:
        ...
        if gate_type.__name__ == 'Canonical':
            def _format_float(x):
            ...
            x_str, y_str, z_str = _format_float(gate.x), _format_float(gate.y), _format_float(gate.z)
            return r"\mathrm{Can}" + "({},{},{})".format(x_str, y_str, z_str)
