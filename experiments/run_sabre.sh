...
commands=(
    ...
    "./bench_all_sabre.py -t chain -isa zzphase_"
    "./bench_all_sabre.py -t chain -isa sqisw_"
    "./bench_all_sabre.py -t chain -isa het"
    ...
    "./bench_all_sabre.py -t hhex -isa zzphase_"
    "./bench_all_sabre.py -t hhex -isa sqisw_"
    "./bench_all_sabre.py -t hhex -isa het"
    ...
    "./bench_all_sabre.py -t square -isa zzphase_"
    "./bench_all_sabre.py -t square -isa sqisw_"
    "./bench_all_sabre.py -t square -isa het"
)
